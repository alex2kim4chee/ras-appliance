...
export const SERVICES: Service[] = [
  { id: 'refrigerator', name: 'Refrigerator', icon: LuRefrigerator, image: '/devices/fridge.webp', description: "Repair for all refrigerator issues, including cooling problems, leaks, and noisy operation.", commonIssues: ['Not cooling', 'Leaking water', 'Freezer is defrosting', 'Making loud noises'] },
  { id: 'washer', name: 'Washer', icon: LuWashingMachine, image: '/devices/washer.webp', description: "Expert washer repair for leaks, spin cycle issues, and error codes.", commonIssues: ['Not spinning', 'Leaking', 'Won\'t turn on', 'Making strange noises'] },
  { id: 'dryer', name: 'Dryer', icon: LuFan, image: '/devices/dryer.webp', description: "Fast dryer repair for no-heat problems, tumbling issues, and long drying times.", commonIssues: ['Not heating', 'Not tumbling', 'Takes too long to dry', 'Loud squeaking or grinding'] },
  { id: 'dishwasher', name: 'Dishwasher', icon: LuUtensilsCrossed, image: '/devices/dish.webp', description: "Complete dishwasher repair services for poor cleaning, leaks, and electronic faults.", commonIssues: ['Not draining', 'Dishes are still dirty', 'Leaking from the door', 'Making unusual noises'] },
  { id: 'oven', name: 'Oven', icon: LuMicrowave, image: '/devices/oven.webp', description: "Reliable oven repair for all brands. We fix heating elements, thermostats, and more.", commonIssues: ['Not heating', 'Baking unevenly', 'Door won\'t close', 'Self-cleaning not working'] },
  { id: 'stove-range', name: 'Stove/Range', icon: LuCookingPot, image: '/devices/stove.webp', description: "Servicing all major stove and range brands for burner, ignition, and control board problems.", commonIssues: ['Burner won\'t light', 'Temperature not accurate', 'Indicator light stays on', 'Control panel not working'] },
  { id: 'cooktop', name: 'Cooktop', icon: LuFlame, image: '/devices/cooktop.webp', description: "Specialized cooktop repair for induction, electric, and gas models.", commonIssues: ['Element not heating', 'Igniter keeps clicking', 'Cracked glass surface', 'Controls unresponsive'] },
  { id: 'wine-cooler', name: 'Wine Cooler', icon: LuWine, image: '/devices/wine-4.webp', description: "Premium wine cooler and cellar repair to protect your collection.", commonIssues: ['Not cooling', 'Too cold / freezing', 'Leaking water', 'Won\'t turn on'] },
];
